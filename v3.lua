...
function library:CreateWindow(name, theme)
    ...
    function InsideLibrary:CreateTab(text)
        ...
        function InsideTab:CreateSearchBar(text, callback)
            callback = callback or function() end
            ...
            SearchFrame.BackgroundColor3 = theme1
            ...
            SearchFrame.MouseLeave:Connect(function()
                TweenService:Create(SearchFrame, TweenInfo.new(0.2), {BackgroundColor3 = theme1}):Play()
            end)
            ...
            SearchIcon.Text = "🔍"
            SearchIcon.TextColor3 = theme3
            SearchIcon.TextSize = 16
            
            SearchBox.Parent = SearchFrame
            SearchBox.BackgroundTransparency = 1
            SearchBox.Position = UDim2.new(0, 45, 0, 0)
            SearchBox.Size = UDim2.new(1, -85, 1, 0)
            SearchBox.Font = Enum.Font.Gotham
            SearchBox.PlaceholderText = text or "Search..."
            SearchBox.Text = ""
            ...
            SearchBox.Focused:Connect(function()
                TweenService:Create(SearchIcon, TweenInfo.new(0.2), {TextColor3 = theme3}):Play()
                TweenService:Create(SearchFrame, TweenInfo.new(0.2), {
                    BackgroundColor3 = Color3.fromRGB(theme1.R * 255 * 1.2, theme1.G * 255 * 1.2, theme1.B * 255 * 1.2)
                }):Play()
            end)
            
            SearchBox.FocusLost:Connect(function()
                if SearchBox.Text == "" then
                    TweenService:Create(SearchIcon, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(150, 150, 150)}):Play()
                end
            end)
            ...
            ClearButton.MouseEnter:Connect(function()
                TweenService:Create(ClearButton, TweenInfo.new(0.2), {TextColor3 = theme3, Rotation = 90}):Play()
            end)
            
            ClearButton.MouseLeave:Connect(function()
                TweenService:Create(ClearButton, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(150, 150, 150), Rotation = 0}):Play()
            end)
            
            return SearchBox
        end
        
        function InsideTab:CreateKeybind(text, default, callback)
            callback = callback or function() end
            ...
            KeybindButton.MouseButton1Click:Connect(function()
                ...
                connection = game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessed)
                    if input.UserInputType == Enum.UserInputType.Keyboard then
                        ...
                        -- Pulse effect
                        TweenService:Create(KeybindButton, TweenInfo.new(0.1), {TextSize = 13}):Play()
                        wait(0.1)
                        TweenService:Create(KeybindButton, TweenInfo.new(0.1), {TextSize = 11}):Play()
